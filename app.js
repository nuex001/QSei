...
const bot_link = "https://t.me/soon_academy_bot";
...
bot.start((ctx) => {
  ...
  ctx.reply(
    `Hey ${username}! It's SOON Academy! 🌟 Your go-to app for getting onboarded on Soon, right in your pocket!📱\n\We're rolling out our Telegram mini app! Start farming points now, and who knows what cool stuff you'll snag with them soon! 🚀\n\nGot friends? Bring 'em in! The more, the merrier! 🌱\n\nRemember: SOON Academy is where growth thrives and endless opportunities await!!!`,
    {
      reply_markup: {
        inline_keyboard: [
          [
            {
              text: "Launch SOON Academy",
